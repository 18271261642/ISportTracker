...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private void init(Context context) {
		...
		mSelectedDrawable = mContext.getResources().getDrawable(R.drawable.calendar_view_selected);
...
//		canvas.drawRect(surface.weekHeight, surface.width, surface.weekHeight, surface.width, surface.cellBgPaint);
	...
	private void drawCellBg(Canvas canvas, int index, int color) {
		...
		float bottpm = top + surface.cellHeight
				- surface.borderWidth;
		mSelectedDrawable.setBounds((int)left, (int)top,(int)right
				,(int)bottpm );
...
//		}
	...
	private class Surface {
		...
		//private int textColorUnimportant = 0xff666666");
		private int btnColor = 0xff666666;
		private int borderColor = 0xffCCCCCC;
		public int todayNumberColor = Color.BLACK;
		public int cellDownColor = 0xffCCFFFF;
		public int cellSelectedColor = 0xff99CCFF;
