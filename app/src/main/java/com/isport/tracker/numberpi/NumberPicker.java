...
package com.isport.tracker.numberpi;
...
public class NumberPicker extends LinearLayout {
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (!mHasSelectorWheel && mIncrementButton!= null) {
            mIncrementButton.setEnabled(enabled);
        }
        if (!mHasSelectorWheel && mDecrementButton!= null) {
    ...
    private boolean updateInputTextView() {
        ...
        return !TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString());
